...
function PwdChecker() {
  ...
  return (
    <div>
      <p style={MS.note}><img src="/kamo/kamo-shield.png" alt="" style={{width:22,height:22,objectFit:'contain'}} /> Ton mot de passe ne quitte pas ton appareil.</p>
  ...
  return (
    <div>
      ...
      <motion.div style={MS.pseudoBox} key={p} initial={{ scale: 0.96, opacity: 0 }} animate={{ scale: 1, opacity: 1 }}>
        <img src="/kamo/kamo-wave.png" alt="" style={{ width: 36, height: 36, objectFit: 'contain' }} />
...
function ToolModal({ toolId, onClose }) {
  ...
  const TOOL_IMG = {
    'password-checker': '/kamo/kamo-shield.png',
    'pseudo-gen': '/kamo/kamo-wave.png',
    'email-gen': '/kamo/kamo-laptop.png',
    'email-rgpd-access': '/kamo/kamo-id.png',
    'email-rgpd-delete': '/kamo/kamo-id.png',
    'email-plainte': '/kamo/kamo-warning.png',
  }
  return (
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: tool.colorLight, border: `2px solid ${tool.color}30`, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <img src={TOOL_IMG[toolId] || '/kamo/kamo-wave.png'} alt="" style={{ width: 32, height: 32, objectFit: 'contain' }} />
            </div>
            <div>
      ...
      <div style={S.inner}>
        <motion.div style={{ marginBottom: 28 }} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 6 }}>
            <img src="/kamo/kamo-laptop.png" alt="" style={{ width: 48, height: 48, objectFit: 'contain' }} />
            <div>
