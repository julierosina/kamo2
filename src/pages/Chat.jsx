      ...
      <div style={S.header}>
        <div style={S.headerInner}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={S.av}>
              <img src="/kamo/kamo-wave.png" alt="Kamo" style={{ width: 38, height: 38, objectFit: 'contain' }} />
              <div style={S.dot} />
            </div>
            <div>
      ...
      <div style={S.msgs}>
        {history.length === 0 && (
          <motion.div style={S.welcome} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <img src="/kamo/kamo-wave.png" alt="" style={{ width: 76, height: 76, objectFit: 'contain', display: 'block', margin: '0 auto 14px' }} />
        ...
        <AnimatePresence>
          {history.map((m, i) => (
            <motion.div key={i} style={{ ...S.row, justifyContent: m.role === 'user' ? 'flex-end' : 'flex-start' }}
              ...
              {m.role === 'assistant' && (
                <div style={S.kamoAv}>
                  <img src="/kamo/kamo-wave.png" alt="" style={{ width: 26, height: 26, objectFit: 'contain' }} />
                </div>
              )}
        ...
        {loading && (
          <motion.div style={{ ...S.row, justifyContent: 'flex-start' }} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div style={S.kamoAv}><img src="/kamo/kamo-zen.png" alt="" style={{ width: 26, height: 26, objectFit: 'contain' }} /></div>
        ...
        {error && (
          <motion.div style={S.errBox} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <img src="/kamo/kamo-warning.png" alt="" style={{ width: 22, height: 22, objectFit: 'contain' }} />
