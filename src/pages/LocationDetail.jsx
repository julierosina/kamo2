      ...
      <div style={{ ...S.headerBg, background: theme.colorLight }}>
        <div style={S.headerInner}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <img src={THEME_IMAGES[themeId] || '/kamo/kamo-wave.png'} alt="" style={{ width: 56, height: 56, objectFit: 'contain' }} />
            <div>
          ...
          {view === 'tasks' && (
            <motion.div key="tasks" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -14 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 20 }}>
                <img src="/kamo/kamo-book.png" alt="" style={{ width: 36, height: 36, objectFit: 'contain' }} />
              ...
              {progress === 1 && (
                <motion.div style={{ ...S.completeBox, borderColor: theme.color, background: `${theme.color}0A` }}
                  ...
                  <img src="/kamo/kamo-shield.png" alt="" style={{ width: 60, height: 60, objectFit: 'contain' }} />
...
const THEME_IMAGES = {
  banque: '/kamo/kamo-phone.png',
  tour:   '/kamo/kamo-umbrella.png',
  port:   '/kamo/kamo-warning.png',
  place:  '/kamo/kamo-id.png',
  labo:   '/kamo/kamo-idea.png',
}
