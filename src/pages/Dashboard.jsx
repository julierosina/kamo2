      ...
      <div style={S.inner}>
        ...
        {hasLeaks && (
          <motion.div style={S.leakBanner} initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <img src="/kamo/kamo-warning.png" alt="" style={{ width: 32, height: 32, objectFit: 'contain' }} />
        ...
        <motion.div style={{ ...S.hero, position: 'relative', overflow: 'hidden' }}
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            <img src="/kamo/kamo-wave.png" alt="Kamo" style={{ width: 70, height: 70, objectFit: 'contain' }} />
            <div style={{ flex: 1 }}>
...
function buildSuggestions(scores) {
  const list = []
  if ((scores.passwords || 0) < 50) list.push({ img: '/kamo/kamo-phone.png', themeId: 'banque', title: 'Renforce tes mots de passe', text: 'Installe un gestionnaire de mots de passe' })
  if ((scores.networks || 0) < 50) list.push({ img: '/kamo/kamo-umbrella.png', themeId: 'tour', title: 'Sécurise tes connexions', text: 'Protège-toi sur les réseaux publics' })
  if ((scores.phishing || 0) < 60) list.push({ img: '/kamo/kamo-warning.png', themeId: 'port', title: 'Entraîne-toi au phishing', text: 'Reconnaître les emails frauduleux' })
  if ((scores.privacy || 0) < 50) list.push({ img: '/kamo/kamo-id.png', themeId: 'place', title: 'Protège ta vie privée', text: 'Configure tes paramètres de confidentialité' })
