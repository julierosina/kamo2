      ...
      <AnimatePresence mode="wait">
        ...
        {step === 0 && (
          <motion.div key="s0" style={S.card} {...FU}>
            <motion.img src="/kamo/kamo-wave.png" alt="Kamo" style={S.bigImg}
        ...
        {step === 1 && (
          <motion.div key="s1" style={S.card} {...FU}>
            ...
            <img src="/kamo/kamo-laptop.png" alt="" style={{ width: 72, height: 72, objectFit: 'contain', marginBottom: 16 }} />
          ...
          <motion.div key="s3" style={S.card} {...FU}>
            {calculating ? (
              <div style={{ textAlign: 'center', padding: '48px 0' }}>
                <motion.img src="/kamo/kamo-zen.png" alt="" style={{ width: 90, height: 90, objectFit: 'contain', display: 'block', margin: '0 auto 20px' }}
              ...
              <>
                <div style={{ textAlign: 'center', marginBottom: 28 }}>
                  <motion.img src="/kamo/kamo-shield.png" alt="" style={{ width: 90, height: 90, objectFit: 'contain', display: 'block', margin: '0 auto 12px' }}
